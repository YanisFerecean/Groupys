...
interface PlaylistCardProps {
  ...
  artworkUrl?: string
  isMine?: boolean
  /** Optional track count line. */
  meta?: string
  actions?: ReactNode
}

/**
 * Presentational playlist card (chat × music plan, ticket 0.3). Wired with data in ticket 2.3.
 */
export function PlaylistCard({ title, subtitle, artworkUrl, isMine = false, meta, actions }: PlaylistCardProps) {
  return (
    <View
