    ...
    <section className="py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="relative flex justify-center lg:justify-start">
          {/* Mobile Mockup 1 */}
          <div className="relative z-20 w-[280px] h-[580px] bg-on-surface rounded-[3rem] p-3 shadow-2xl overflow-hidden border-4 border-surface-container-high">
            <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
              <img alt="Groupys mobile app" className="w-full h-full object-cover" src={mockupSrc} />
            </div>
          </div>
          {/* Mobile Mockup 2 */}
          <div className="absolute z-10 top-20 -right-4 lg:right-10 w-[280px] h-[580px] bg-on-surface rounded-[3rem] p-3 shadow-2xl overflow-hidden border-4 border-surface-container-high opacity-80 scale-90">
            <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
