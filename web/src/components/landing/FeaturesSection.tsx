...
export default function FeaturesSection() {
  return (
    <section className="bg-surface-container-low py-32" id="features">
      <div className="max-w-7xl mx-auto px-8">
        <div className="mb-20">
          <h2 className="text-3xl font-bold mb-4">Built around music. Built around people.</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f) => (
            <div
              key={f.title}
              className="bg-surface-container-lowest p-10 rounded-[2rem] hover:-translate-y-2 transition-all duration-300"
            >
