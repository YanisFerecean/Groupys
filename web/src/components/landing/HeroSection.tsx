    ...
    <section className="max-w-7xl mx-auto px-6 sm:px-8 mb-16 md:mb-32 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
      <div className="lg:col-span-6 space-y-6 md:space-y-8">
        ...
        <div className="flex flex-wrap gap-3 md:gap-4 pt-2 md:pt-4">
          <button className="px-6 py-3 md:px-8 md:py-4 bg-primary text-on-primary rounded-full font-bold text-base md:text-lg hover:shadow-xl hover:shadow-primary/20 transition-all">
            Join the Waitlist
          </button>
          <button className="px-6 py-3 md:px-8 md:py-4 bg-surface-container-high text-on-surface rounded-full font-bold text-base md:text-lg hover:bg-surface-container-highest transition-all">
            See Features
          </button>
        </div>
      </div>
      ...
      <div className="lg:col-span-6 relative">
        <div className="relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden bg-surface-container-low aspect-square shadow-2xl">
          <img
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8">
            <div className="w-full h-full glass-nav rounded-2xl md:rounded-3xl border border-white/20 p-4 sm:p-6 flex flex-col justify-between">
              <div className="flex justify-between items-start gap-2">
                <div className="bg-white/90 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full shadow-sm text-xs sm:text-sm font-bold flex items-center gap-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="bg-white/95 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg transform translate-x-2 sm:translate-x-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-200 overflow-hidden shrink-0">
                      <img
                        alt="User profile"
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-xs sm:text-sm truncate">Hana Sato</p>
                      <p className="text-xs text-on-surface-variant truncate">Album of the Week: Currents</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white/95 p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg transform -translate-x-2 sm:-translate-x-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-bold text-xs sm:text-sm truncate">Kenji Chen</p>
                      <p className="text-xs text-on-surface-variant truncate">Shared artists: Tame Impala, Bicep</p>
                    </div>
                  </div>
                </div>
              </div>
